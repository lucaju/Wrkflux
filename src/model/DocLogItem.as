package model {
	...
	public class DocLogItem {
		...
		protected var _status			:FlagModel;
		 ...
		 * 
		 */
		public function get status():FlagModel {
			return _status;
		}
		 ...
		 * 
		 */
		protected function convertStatus(sourceStatus:String):FlagModel {
			
			var treatedStatus:FlagModel;
