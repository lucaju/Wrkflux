package view {
	...
	public class StructureView extends AbstractView {
		...
		public function init(actArea:Rectangle):void {
			...
			//listenter
			WorkflowController(this.getController()).getModel("structure").addEventListener(WrkfluxEvent.UPDATE_STEP, updateStep);
		 ...
		 * 
		 */
		protected function updateStep(e:WrkfluxEvent):void {
