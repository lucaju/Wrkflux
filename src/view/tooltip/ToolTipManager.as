package view.tooltip {
	...
	public class ToolTipManager{	
		...
		static protected var _toolTipBaseColor				:uint;
		static protected var _toolTipBaseAlpha				:Number;
		static protected var _toolTiptextColor				:uint;
		
		static protected var target							:Sprite;
		static protected var toolTipCollection				:Array;
		static protected var verticalOffset					:uint;
		 ...
		 * 
		 */
		public function ToolTipManager(target:Sprite) {
			
			ToolTipManager.target = target;
		
			_toolTipBaseAlpha = 1;
			_toolTipBaseColor = Colors.getColorByName(Colors.WHITE);;
			_toolTiptextColor = Colors.getColorByName(Colors.BLACK);
		 ...
		 * 
		 */
		static public function addToolTip(data:Object, direction:String = Directions.BOTTOM):void {
			...
			if (toolTip.y - toolTip.height < 0) {
				...
				toolTip.arrowDirection = Directions.TOP;
				animOffset = -5;
				toolTip.y = data.position.y + toolTip.height + verticalOffset;
			...
			//move Arrow
			if (horizontalOffset != 0) toolTip.arrowOffsetX(horizontalOffset);
		...
		static public function removeToolTip(value:int):void {
			...
			if (toolTip) {
				...
				if (toolTip.arrowDirection == Directions.BOTTOM) {
					animOffset = 5;
				} else if (toolTip.arrowDirection == Directions.TOP) {
					animOffset = -5;
				}
		 ...
		 * 
		 */
		static public function removeAll(event:MouseEvent = null):void {
