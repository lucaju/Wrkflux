package view.workflow.flow.pin {
	...
	public class PinTrail {
		 ...
		 * 
		 */
		protected function draw(event:WrkfluxEvent):void {
		...
		public function start():void {
			target.addEventListener(WrkfluxEvent.DRAG_PIN, draw);
		...
		public function stop():void {
			...
			target.removeEventListener(WrkfluxEvent.DRAG_PIN, draw);
			canvas = null;
		}
